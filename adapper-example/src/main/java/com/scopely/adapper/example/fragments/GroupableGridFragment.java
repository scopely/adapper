...
import com.scopely.adapper.extras.GroupableSpanSizeLookup;
 ...
 *
 */
public class GroupableGridFragment extends AbstractFragment<GroupableAdapper> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GroupableSpanSizeLookup spanSizeLookup = new GroupableSpanSizeLookup(adapter, ITEMS_PER_ROW);
        GridLayoutManager manager = new GridLayoutManager(inflater.getContext(), spanSizeLookup.getRequiredSpans());
