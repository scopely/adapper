...
public class GroupableSpanSizeLookup extends InvertedSpanSizeLookup {
    ...
    public GroupableSpanSizeLookup(GroupPositionIdentifier groupPositionIdentifier, int spanCount) {
        super(1, spanCount);
    ...
    public int getItemsPerRow(int position) {
        return groupPositionIdentifier.isGroup(position) ? 1 : spanCount;
    }
}
